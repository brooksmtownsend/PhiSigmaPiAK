...
linkarray[3] = <Text style={{color: '#55afad'}} onPress={() => Linking.openURL(flickr)}> Flickr {"\n"}</Text>;
linkarray[4] = <Text style={{color: '#55afad'}} onPress={() => Linking.openURL(sops)}> Standard Operating Procedures/Bylaws {"\n"}</Text>;
linkarray[5] = <Text style={{color: '#55afad'}} onPress={() => Linking.openURL(idea)}> Idea Box {"\n"}</Text>;
linkarray[6] = <Text style={{color: '#55afad'}} onPress={() => Linking.openURL(fallphotos)}> Fall 2017 Google Photo{"\n"}</Text>;
